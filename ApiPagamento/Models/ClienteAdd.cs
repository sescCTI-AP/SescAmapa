...
namespace PagamentoApi.Models
{
    public class ClienteDb2
    {
        ...
        public System.TimeSpan HRATU { get; set; } = new TimeSpan(DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Second);
        ...
        public EnderecoDb2 ENDERECO { get; set; }
    }
    ...
    public class EnderecoDb2
    {
        ...
        public Nullable<System.TimeSpan> HRATU { get; set; } = new TimeSpan(DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Second);
    ...
    {
        public string IDCLASSE { get; set; } = "CLI01";
        public string CDELEMENT { get; set; }
        public int TPCONTATO { get; set; }
        public short STPRINCIPAL { get; set; }
        public string? NUDDD { get; set; }
        public string DSCONTATO { get; set; }
        public string NMPESSOA { get; set; }
        public TimeSpan HRATU { get; set; } = new TimeSpan(DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Second);
        public double SMFIELDATU { get; set; } = 0;
        public DateTime DTATU { get; set; } = DateTime.Now.Date;
        public string LGATU { get; set; } = "web";
        public int CDUOP { get; set; }
        public int SQMATRIC { get; set; }
        public short STRECEBEINFO { get; set; }
    }
}
