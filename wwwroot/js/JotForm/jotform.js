                ...
                HTMLFormElement.prototype.submit = (function (originalSubmitFn) {
                    return function () {
                        try {
                            ...
                            var directValidationFeatureFlag = !JotForm.payment && parseInt(this.id, 10) % 10 < 5;
...
//                        p.$jot('.jt-content, .jt-title').css('width', 'auto');
    ...
    */
    ...
    getSelectedSubscriptionCustomData: function () {
    ...
    getSubscriptionPriceSummary: function() {
        const customData = this.getSelectedSubscriptionCustomData();
        const selectedSubscriptionPid = Object.keys(customData[0])[0];
    ...
    showFormSection: function (section, withoutFocus) {
        ...
        if (firstLabel && !firstLabel.closest('.form-section-closed') && !withoutFocus) {
            ...
            if (inputElementID){
                ...
                var isIosSelectBox = inputElement && JotForm.browserIs.ios();
            ...
            var handleFormSubmit = function (e) {
                ...
                try {
                    if (
                        ...
                        || window.location.href.includes('mirac.jotform.pro')
                    ) {
                        ...
                        if (window.paymentType === 'subscription') {
                            ...
                            }).putValue(JSON.stringify(JotForm.getSelectedSubscriptionCustomData())));
                        }
                        ...
                        if (JotForm.pricingInformations && JotForm.pricingInformations.general) {
                            ...
                            const paymentSummary = {
                                ...
                                shipping_discounted: JotForm.morePreciseToFixed(shippingDiscountApplied ? shipping : 0) || 0,
                                tax: JotForm.morePreciseToFixed(taxTotalWithoutDiscount) || 0,
                                tax_discounted: JotForm.morePreciseToFixed(isProductCoupon && taxDiscountValue > 0 ? tax_total : 0) || 0,
                                ...
                                ...(window.paymentType === 'subscription' && { ...JotForm.getSubscriptionPriceSummary() })
                            };
                            form.insert(new Element('input', {
                                type: 'hidden',
                                name: 'paymentSummary'
